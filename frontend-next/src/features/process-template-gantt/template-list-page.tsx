/* ── Process Templates V2 – List Page ─────────────────────────────
 *
 * Industrial-grade template list using Precision Lab design system.
 * Full CRUD: search, create, copy, delete.
 */
            ...
            <div>
              {filtered.map((t) => (
                <div
                  ...
                  onClick={() =>
                    router.push(`/process-templates-v2/${t.id}`)
                  }
                  role="button"
                  tabIndex={0}
                  onKeyDown={(e) => {
