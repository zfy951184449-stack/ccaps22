...
class HighsOptionsProto(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["bool_options", b"bool_options", "double_options", b"double_options", "int_options", b"int_options", "string_options", b"string_options"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___HighsOptionsProto: typing_extensions.TypeAlias = HighsOptionsProto
