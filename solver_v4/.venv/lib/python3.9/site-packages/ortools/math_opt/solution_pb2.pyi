...
class DualSolutionProto(google.protobuf.message.Message):
    ...
    QUADRATIC_DUAL_VALUES_FIELD_NUMBER: builtins.int
    ...
    @property
    def quadratic_dual_values(self) -> ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto:
        """Requirements:
    ...
    @property
    def reduced_costs(self) -> ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto:
        """Requirements:
    ...
    def __init__(
        ...
        *,
        ...
        quadratic_dual_values: ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto | None = ...,
        reduced_costs: ortools.math_opt.sparse_containers_pb2.SparseDoubleVectorProto | None = ...,
        objective_value: builtins.float | None = ...,
        feasibility_status: Global___SolutionStatusProto.ValueType = ...,
    ) -> None: ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["_objective_value", b"_objective_value", "dual_values", b"dual_values", "objective_value", b"objective_value", "quadratic_dual_values", b"quadratic_dual_values", "reduced_costs", b"reduced_costs"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["_objective_value", b"_objective_value", "dual_values", b"dual_values", "feasibility_status", b"feasibility_status", "objective_value", b"objective_value", "quadratic_dual_values", b"quadratic_dual_values", "reduced_costs", b"reduced_costs"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
