...
class CpSolverRequest(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["model", b"model", "parameters", b"parameters"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["model", b"model", "parameters", b"parameters"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___CpSolverRequest: typing_extensions.TypeAlias = CpSolverRequest
