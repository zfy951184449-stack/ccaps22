...
class IntVarAssignment(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["active", b"active", "max", b"max", "min", b"min", "var_id", b"var_id"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___IntVarAssignment: typing_extensions.TypeAlias = IntVarAssignment
...
class IntervalVarAssignment(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["active", b"active", "duration_max", b"duration_max", "duration_min", b"duration_min", "end_max", b"end_max", "end_min", b"end_min", "performed_max", b"performed_max", "performed_min", b"performed_min", "start_max", b"start_max", "start_min", b"start_min", "var_id", b"var_id"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___IntervalVarAssignment: typing_extensions.TypeAlias = IntervalVarAssignment
...
class SequenceVarAssignment(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["active", b"active", "backward_sequence", b"backward_sequence", "forward_sequence", b"forward_sequence", "unperformed", b"unperformed", "var_id", b"var_id"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___SequenceVarAssignment: typing_extensions.TypeAlias = SequenceVarAssignment
...
class WorkerInfo(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["bns", b"bns", "worker_id", b"worker_id"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class AssignmentProto(google.protobuf.message.Message):
    ...
    _HasFieldArgType: typing_extensions.TypeAlias = typing.Literal["worker_info", b"worker_info"]
    def HasField(self, field_name: _HasFieldArgType) -> builtins.bool: ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["int_var_assignment", b"int_var_assignment", "interval_var_assignment", b"interval_var_assignment", "is_valid", b"is_valid", "objective", b"objective", "sequence_var_assignment", b"sequence_var_assignment", "worker_info", b"worker_info"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___AssignmentProto: typing_extensions.TypeAlias = AssignmentProto
