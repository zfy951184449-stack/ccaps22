...
class RegularLimitParameters(google.protobuf.message.Message):
    ...
    _ClearFieldArgType: typing_extensions.TypeAlias = typing.Literal["branches", b"branches", "cumulative", b"cumulative", "failures", b"failures", "smart_time_check", b"smart_time_check", "solutions", b"solutions", "time", b"time"]
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___RegularLimitParameters: typing_extensions.TypeAlias = RegularLimitParameters
