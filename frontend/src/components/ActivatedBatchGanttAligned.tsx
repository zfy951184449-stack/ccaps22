    ...
    .sort((a, b) => {
      ...
      return a.stageName.localeCompare(b.stageName, 'zh-CN');
        ...
        .forEach((stageEntry, stageIndex) => {
          ...
          const sortedOps = stageEntry.operations
            .slice()
            .sort((a, b) =>
...
const ActivatedBatchGantt: React.FC<ActivatedBatchGanttProps> = ({
  ...
  const renderOperationBlock = (
    ...
    if (op.assignment_status === 'UNASSIGNED') statusColor = '#ef4444';
    else if (op.assignment_status === 'PARTIAL') statusColor = '#f97316';
    else if (op.assignment_status === 'COMPLETE') statusColor = '#22c55e';
      ...
      if (meta.type === 'operation') {
        ...
        rows.push(
          <div
            ...
            style={{ top, height: ROW_HEIGHT }}
            onMouseEnter={() => setHoveredKey(opRow.key)}
            onMouseLeave={() => setHoveredKey(null)}
          >
