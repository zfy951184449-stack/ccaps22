...
运行：
  cd solver_v5 && python3 -m unittest tests.test_callback_auth
"""
import os
import unittest
from unittest.mock import patch, MagicMock

from core.callback import APICallbackV5 as APICallback

PROGRESS_URL = "http://localhost:3001/api/v5/scheduling/callback/progress"
