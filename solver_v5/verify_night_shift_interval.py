...
# NightShiftInterval is now merged into NightShiftConstraint in V5
from constraints.night_shift import NightShiftConstraint as NightShiftIntervalConstraint

# Configure logging
logging.basicConfig(level=logging.INFO)
# logging.getLogger("Constraint.NightShift").setLevel(logging.DEBUG)
