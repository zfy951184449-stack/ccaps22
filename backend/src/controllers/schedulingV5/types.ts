/**
 * Scheduling V5 - Type Definitions & Constants
 */
import { EventEmitter } from 'events';

// In-memory event emitter for real-time progress broadcasting
export const progressEmitterV5 = new EventEmitter();
progressEmitterV5.setMaxListeners(100);

// V5 Solver Service URL
export const SOLVER_V5_URL = process.env.SOLVER_V5_URL || 'http://localhost:5006';
...
export interface ResultSummaryV5 {
    metrics: {
