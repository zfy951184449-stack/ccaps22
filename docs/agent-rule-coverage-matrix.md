...
| Frontend / UI / state management work | Covered | `.agent/rules/codex-frontend-ui-rules.md`, `docs/frontend-visual-language.md`, `docs/frontend-next-visual-language.md` | `frontend/` and `frontend-next/` have independent visual languages. Covers reading order, state boundaries, async states, density, overflow, typography, page composition, and feature-level style boundaries. |
...
| Multi-persona task governance | Covered | `.agent/personas/README.md`, `.agent/workflows/multi-persona-task.md` | 6-role system (Host/Planner/Reviewer/Challenger/Coder/QA) with trigger rules and cycle limits. |
